...
export default function Stack(){
    return (
            <section id={"stack"} className={"z-20 py-[60px] lg:py-0 w-full text-primary-content relative"}>
                <div className={"relative justify-end px-10 lg:grid grid-cols-2 min-h-lvh  pt-[60px] lg:pt-0"}>
                    <div className={"text-3xl self-center lg:p-10 text-left relative uppercase lg:col-span-1"}>
                        ...
                        <div className={'flex flex-col items-end w-full pt-[100px] lg:pt-0'}>
                            <StackWrapper/>
                        </div>
                    </div>
                </div>
