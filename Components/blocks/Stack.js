...
export default function Stack(){
    return (
            <section id={"stack"} className={"z-10 w-full text-primary-content relative"}>
                <div className={"relative justify-end z-40 px-10 lg:grid grid-cols-2 min-h-screen  pt-[60px] lg:pt-0"}>
