...
export default function Reals({showReals, setShowReals,changeShowReals}){
    return (
        <section id={'reals'} className={`z-40 px-10 w-full reals bg-secondary text-primary-content min-h-screen fixed bottom-0 duration-700 ${showReals ? 'translate-x-0':'translate-x-full'} overflow-y-scroll`}>
